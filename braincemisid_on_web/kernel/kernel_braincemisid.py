...
class KernelBrainCemisid():
    ...
    def __init__(self,user,project,frontend_request):
        ...
        if frontend_request == "PUT":
            ...
            #for i in self.syllables_net.group_list:
                ...
                #print(i.__dict__)
            # Words net
            self.words_net = CulturalNetwork.deserialize("words_net", self.project_id)
    ...
    def set_internal_state(self, states_vector ):
        ...
        if state_correctly_set:
            ...
            InternalState.serialize(self.internal_state, "internal_state", self.project_id)
    ...
    def set_desired_state(self, states_vector ):
        ...
        if state_correctly_set:
            ...
            InternalState.serialize(self.desired_state, "desired_state", self.project_id)
        return state_correctly_set
