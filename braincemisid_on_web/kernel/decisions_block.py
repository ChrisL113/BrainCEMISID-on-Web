...
class DecisionsBlock:
    ...
    def deserialize(cls, name, project_id):
        ...
        # print("############################################################################################### DECISIONS BLOCK ###########################################################")
        # print(" ")
        # print("OVERALL -> ",aux.__dict__)
        # print(" ")
        # print("UNCONSCIOUS -> ",aux.unconscious_block.__dict__)
        # print(" ")
        # print("CONSCIOUS -> ",aux.conscious_block.__dict__)
        # print(" ")
        # print("CONSCIOUS DESIRED STATE -> ",aux.conscious_block.desired_state.__dict__)
        # print("CONSCIOUS INTERNAL STATE -> ",aux.conscious_block.internal_state.__dict__)
        # print(" ")
        # print("CONSCIOUS DECISION BY PREDICTION ->",aux.conscious_block.decision_prediction_block.__dict__)
        # print(" ")
        # print("CONSCIOUS DECISION BY PREDICTION DESIRED STATE ->",aux.conscious_block.decision_prediction_block.desired_state.__dict__)
        # print("CONSCIOUS DECISION BY PREDICTION INTERNAL STATE ->",aux.conscious_block.decision_prediction_block.internal_state.__dict__)
        # print(" ")
