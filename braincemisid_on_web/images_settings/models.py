...
class ImageSettings (models.Model):
    ...
    brain = models.ForeignKey(brain, related_name="imageSettingsFromBrain",on_delete=models.CASCADE, null=True)
    image = models.ForeignKey(ImagesFromNeuron, related_name="imageSettingsFromImage",on_delete=models.CASCADE, null=True)
    owner = models.ForeignKey(User, related_name="imageSettingsFromOwner", on_delete=models.CASCADE, null=True)