...
from .serializers import  NeuronNetworkSerializer,NeuronSightSerializer
...
class SightNeuronsViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        if  "project_id" in request.data:
            ...
            project_id=request.data['project_id']
            try:
                query=RbfNeuron.objects.filter(snb_sight__brain_s__pk=project_id, has_knowledge=True)
                #print(query.values())
